...
public class CustomerTest {
    ...
    @Test
    public void testValidateCustomer() throws IOException {
        Customer c = new Customer();
    ...
    @Test
    public void testUpdateCNIC() throws IOException {
        Customer c = new Customer();
    ...
    @Test
    public void testViewExpireCnic() throws IOException {
        Customer c = new Customer();
    ...
    @Test
    public void testViewSearchCNIC() throws IOException {
        Customer c = new Customer();
    ...
    @Test
    public void testViewAllCnic() throws IOException {
        Customer c = new Customer();
    ...
    @Test
    public void testViewAllCustomers() throws IOException {
        Customer c = new Customer();
    ...
    @Test
    public void testViewSearchCustomer() throws IOException {
        Customer c = new Customer();
    ...
    @Test
    public void testCnic_count() throws IOException {
        Customer c = new Customer();
    ...
    @Test
    public void testSearchNadraFile() throws IOException {
        Customer c = new Customer();
