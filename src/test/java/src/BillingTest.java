...
public class BillingTest {
    ...
    @Test
    public void testAddNewBill() throws IOException { //-------------make it work
    ...
    @Test
    public void testViewSearchedBills() throws IOException, InterruptedException { //----make it work
        Billing b = new Billing();
    ...
    @Test
    public void testDeleteBill() throws IOException, InterruptedException { //---------make it work
        Billing b = new Billing();
    ...
    @Test
    public void testIsAccessAble() throws IOException { //-------------make it work
        Billing b = new Billing();
    ...
    @Test
    public void testChangePaidStatus() throws IOException {//---------make it work
        Billing b = new Billing();
    ...
    @Test
    public void testValidateCustomerID() throws IOException {//----------make it work
        Billing b = new Billing();
    ...
    @Test
    public void testValidateCustomerIDfromBillFile() throws IOException {//---------make it work
        Billing b = new Billing();
